...
public class ExamMapper {
    ...
    public static ExamResponse toResponse(
            Exam exam
    ) {
        ...
        if (exam.getRooms() != null) {
            ...
            List<ExamRoomResponse> rooms =
                    exam.getRooms()
                            .stream()
                            .map(
                                    ExamMapper::toRoomResponse
                            )
    ...
    public static ExamRoomResponse toRoomResponse(
            ExamRoom room
    ) {
        ...
        ExamRoomResponse res =
                new ExamRoomResponse();
    ...
    public static ExamRegistrationResponse toRegistrationResponse(
        ...
        ExamRegistrationResponse res =
                new ExamRegistrationResponse();
    ...
    public static ExamResponse toSimpleResponse(
            Exam exam
    ) {
    ...
    public static ExamResponse toDetailResponse(
            Exam exam
    ) {
